...
const Confirmation = ({codePass }) => {
  ...
  return React.createElement('div', { style: styles.emailContainer },
      ...
      React.createElement('p', { style: styles.text }, "Thank you for registering with Skinmiso Philippines! To complete your registration, please use the following 6-digit verification code:"),
      ...
      React.createElement('p', { style: styles.text }, "Thank you for choosing SKINMISO Philippines!"),
      React.createElement('p', { style: styles.text }, "Best Regards,", 
      React.createElement('br'), 
        "Skinmiso Philippines"
      )
    )
  );
};
